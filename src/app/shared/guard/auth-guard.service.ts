...
import { FetchUserData } from '../../shared/ngrx-store/actions/auth.actions';
...
export class AuthGuardService
   ...
   */
  canActivate(): boolean {
    if (this.isAuth && !this.localStorageService.isVerified()) {
      this.router.navigateByUrl('/');
    }
    if (
      !this.isAuth ||
      this.localStorageService.isAdmin() ||
      this.auth.isTokenExpired(this.localStorageService.getAuthToken())
    ) {
